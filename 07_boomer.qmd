...
- Le package contient également une fonctionnalité (encore expérimentale) pour aider les développeurs à debugger les applications shiny (voir [cette page](https://moodymudskipper.github.io/boomer/articles/shiny.html)).  
